...
class ClientHandler implements Runnable {
    ...
    public void run() {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
            ...
            try {
                String line = reader.readLine(); // Leer solo una línea
                if (line != null) {
    ...
    // -------------------------
    private boolean cargarUsuarioDesdeParametros(Object[] params) {
